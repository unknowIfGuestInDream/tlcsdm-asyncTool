package com.tlcsdm.async.wrapper;

import com.tlcsdm.async.callback.DefaultCallback;
import com.tlcsdm.async.callback.ICallback;
import com.tlcsdm.async.callback.IWorker;
import com.tlcsdm.async.exception.SkippedException;
import com.tlcsdm.async.executor.timer.SystemClock;
import com.tlcsdm.async.worker.DependWrapper;
import com.tlcsdm.async.worker.ResultState;
